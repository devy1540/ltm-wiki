...
<a id="claim-transport-global-grpc-recommendation"></a>
### Claim: transport-global-grpc-recommendation

- **Kind:** derived
- **State:** current
- **Statement:** Every new integration should use gRPC.
- **Derived from:** [transport-all-new-grpc](../topics/transport.md#claim-transport-all-new-grpc)
- **Evidence chain:**
  - [Protocol Review](../../sources/protocol-review.md), heading "Recommendation", lines 5-9
