...
When the user invokes `/ltm-setup` or asks naturally to set up LTM Wiki, initialize long-term memory, connect AI memory, configure an Obsidian memory store, or says "ltm-wiki 초기셋팅", follow `.claude/commands/ltm-setup.md` when available.
